...
public sealed class CollideStepTriggerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CollideStepTriggerComponent, AfterAutoHandleStateEvent>(TriggerHandleState);

        SubscribeLocalEvent<CollideStepTriggerComponent, StartCollideEvent>(OnStartCollide);
        SubscribeLocalEvent<CollideStepTriggerComponent, EndCollideEvent>(OnEndCollide);
#if DEBUG
        SubscribeLocalEvent<CollideStepTriggerComponent, ComponentStartup>(OnStartup);
    }
    private void OnStartup(EntityUid uid, CollideStepTriggerComponent component, ComponentStartup args)
    {
        if (!component.Active)
            return;
    ...
    public override void Update(float frameTime)
    {
        ...
        var enumerator = EntityQueryEnumerator<CollideStepTriggerActiveComponent, CollideStepTriggerComponent, TransformComponent>();
    ...
    private bool Update(EntityUid uid, CollideStepTriggerComponent component, TransformComponent transform, EntityQuery<PhysicsComponent> query)
    {
        if (!component.Active ||
    ...
    private void UpdateColliding(EntityUid uid, CollideStepTriggerComponent component, TransformComponent ownerXform, EntityUid otherUid, EntityQuery<PhysicsComponent> query)
    {
    ...
    private bool CanTrigger(EntityUid uid, EntityUid otherUid, CollideStepTriggerComponent component)
    {
    ...
    private void OnStartCollide(EntityUid uid, CollideStepTriggerComponent component, ref StartCollideEvent args)
    {
        ...
        EnsureComp<CollideStepTriggerActiveComponent>(uid);
    ...
    private void OnEndCollide(EntityUid uid, CollideStepTriggerComponent component, ref EndCollideEvent args)
    {
        var otherUid = args.OtherEntity;
        ...
        {
            RemCompDeferred<CollideStepTriggerActiveComponent>(uid);
        }
    }

    private void TriggerHandleState(EntityUid uid, CollideStepTriggerComponent component, ref AfterAutoHandleStateEvent args)
    {
        if (component.Colliding.Count > 0)
        {
            EnsureComp<CollideStepTriggerActiveComponent>(uid);
    ...
    public void SetIntersectRatio(EntityUid uid, float ratio, CollideStepTriggerComponent? component = null)
    {
    ...
    public void SetRequiredTriggerSpeed(EntityUid uid, float speed, CollideStepTriggerComponent? component = null)
    {
        if (!Resolve(uid, ref component))
            return;
    ...
    public void SetActive(EntityUid uid, bool active, CollideStepTriggerComponent? component = null)
    {
        if (!Resolve(uid, ref component))
            return;
